...
public class ResultSetReader {
    ...
    public ResultSetReader(final ResultSet resultSet, final IMetaObject metaObject, final String columnMapping) {
        this.rsIter = new ResultSetIterator(resultSet, metaObject, columnMapping);
    }
