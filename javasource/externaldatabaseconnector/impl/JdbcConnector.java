...
public class JdbcConnector {
    ...
    public List<IMendixObject> executeCallableQuery(String jdbcUrl, String userName, String password, IMetaObject metaObject, String sql, String queryParameters, String columnMapping, IContext context) throws SQLException, DatabaseConnectorException {
        if (logNode.isTraceEnabled()) logNode.trace(String.format("executeCallableQuery: %s, %s, %s", jdbcUrl, userName, sql));
    ...
    public long executeCallableStatement(String jdbcUrl, String userName, String password, String sql, String queryParameters) throws SQLException, DatabaseConnectorException {
        if (logNode.isTraceEnabled())
            logNode.trace(String.format("executeCallableStatement: %s, %s, %s", jdbcUrl, userName, sql));
